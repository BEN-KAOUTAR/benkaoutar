...
class _GradeEntryScreenState extends State<GradeEntryScreen> {
  ...
  void initState() {
    super.initState();
    selectedClass = classes.isNotEmpty
        ? classes[0]
        : ClassModel(id: '', name: 'Aucune', students: [], studentCount: 0);
  }
        ...
        return StatefulBuilder(builder: (context, setStateModal) {
          return Center(
            child: Container(
                            ...
                            child: DataTable(
                              ...
                              columns: [
                                DataColumn(
                                    label: Text(
                                        AppLocalizations.of(context)!
                                            .translate('table_student_header'),
                                        style: TextStyle(
                                            fontWeight: FontWeight.w900,
                                            color: primaryTextColor,
                                            fontSize: 12))),
              ...
              .animate()
              .fadeIn()
              .scale(begin: const Offset(0.9, 0.9), curve: Curves.easeOutExpo);
        });
      },
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(AppLocalizations.of(context)!.translate('report_cards'),
            style: TextStyle(
                fontWeight: FontWeight.w900,
                color: primaryTextColor,
                fontSize: 18)),
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(AppLocalizations.of(context)!.translate('report_cards'),
                    style: TextStyle(
                        fontWeight: FontWeight.w900,
                        fontSize: 24,
                        color: primaryTextColor,
                ...
                Text(
                    AppLocalizations.of(context)!
                        .translate('grade_selection_subtitle'),
                    style: TextStyle(
                        color: secondaryTextColor,
                        fontSize: 13,
                        fontWeight: FontWeight.bold)),
                  ...
                  children: [
                    Expanded(
                        child: _buildDropdown(
                            ...
                            selectedClass.name, (v) {
                      setState(() => selectedClass =
                          classes.firstWhere((c) => c.name == v));
                    }, isDark)),
                    const SizedBox(width: 16),
                    Expanded(
                        child: _buildDropdown(
                    ...
                    const SizedBox(width: 16),
                    Expanded(
                        child: _buildDropdown(terms, selectedTerm,
                            (v) => setState(() => selectedTerm = v!), isDark)),
                  ],
                ),
                  ...
                  children: [
                    Expanded(
                        ...
                        child: _buildDropdown(
                            assignments,
                            selectedAssignment,
                            (v) => setState(() => selectedAssignment = v!),
                            isDark)),
                    const SizedBox(width: 16),
                    Expanded(
                      flex: 1,
                ...
                Center(
                  child: Icon(Icons.my_library_books_rounded,
                      size: 120, color: isDark ? Colors.white10 : Colors.white),
                ),
                const Spacer(flex: 2),
              ],
            ),
  ...
  Widget _buildDropdown(List<String> items, String value,
      void Function(String?) onChanged, bool isDark) {
        ...
        child: DropdownButton<String>(
          ...
          items: items
              .map((i) => DropdownMenuItem(
                  value: i,
                  child: Text(AppLocalizations.of(context)!.translate(i))))
              .toList(),
          onChanged: onChanged,
        ),
      ),
